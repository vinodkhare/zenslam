...
) -> std::vector<cv::DMatch>
{
    ...
    cv::vconcat
    (
        untriangulated | std::views::transform
        (
            [](const auto& keypoint)
            {
...
auto epipolar_angles(const cv::Vec3d& translation_of_camera1_in_camera0)
{
    ...
    (
        [&translation_of_camera1_in_camera0]
    (
        const cv::Point3d& p
    )
        {
...
) -> std::vector<line3d>
{
    ...
    const auto& points3d_cv_0 = triangulate_points
    (
        points2f_0_0,
        points2f_1_0,
        projection_0,
    ...
    const auto& points3d_cv_1 = triangulate_points
    (
        points2f_0_1,
        points2f_1_1,
        projection_0,
