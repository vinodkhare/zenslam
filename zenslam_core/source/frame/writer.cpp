...
namespace zenslam::frame {
    writer::writer(const std::filesystem::path &path) {
        ...
        _file << "timestamp, t_preprocessing, t_tracking, t_detection, t_matching, t_estimation, t_total, n_keypoints_l, n_keypoints_r, n_tracked_l, n_tracked_r, n_matches, n_triangulated, n_3d3d, n_3d2d, n_3d3d_inliers, n_3d2d_inliers\n";
    }
