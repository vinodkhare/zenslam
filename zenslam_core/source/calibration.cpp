...
) -> calibration
{
    ...
    const auto& stereo_rectify = true; // TODO: make configurable

    if (calib.cameras[0].distortion_model == camera_calibration::distortion_model::equidistant) {}

    auto rotation_0 = cv::Matx33d { };
    auto rotation_1 = cv::Matx33d { };
